 ...
 */
module.exports = class InitSchema1779673894095 {
    name = 'InitSchema1779673894095'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "loan_agreements" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "status" varchar CHECK( "status" IN ('draft','signed') ) NOT NULL DEFAULT ('draft'), "agreementDate" datetime, "lenderName" varchar, "termsText" text, "filePath" varchar, "deletedAt" datetime, "signedAt" datetime, "signedBy" varchar, "debtId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_loan_agreements" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "status" varchar CHECK( "status" IN ('draft','signed') ) NOT NULL DEFAULT ('draft'), "agreementDate" datetime, "lenderName" varchar, "termsText" text, "filePath" varchar, "deletedAt" datetime, "signedAt" datetime, "signedBy" varchar, "debtId" integer, CONSTRAINT "FK_9d82e145d186b22bdd197a139bc" FOREIGN KEY ("debtId") REFERENCES "debts" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_loan_agreements"("id", "status", "agreementDate", "lenderName", "termsText", "filePath", "deletedAt", "signedAt", "signedBy", "debtId") SELECT "id", "status", "agreementDate", "lenderName", "termsText", "filePath", "deletedAt", "signedAt", "signedBy", "debtId" FROM "loan_agreements"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "loan_agreements" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "status" varchar CHECK( "status" IN ('draft','signed') ) NOT NULL DEFAULT ('draft'), "agreementDate" datetime, "lenderName" varchar, "termsText" text, "filePath" varchar, "deletedAt" datetime, "signedAt" datetime, "signedBy" varchar, "debtId" integer)`);
        await queryRunner.query(`INSERT INTO "loan_agreements"("id", "status", "agreementDate", "lenderName", "termsText", "filePath", "deletedAt", "signedAt", "signedBy", "debtId") SELECT "id", "status", "agreementDate", "lenderName", "termsText", "filePath", "deletedAt", "signedAt", "signedBy", "debtId" FROM "temporary_loan_agreements"`);
