...
import { Search, HandCoins, User, DollarSign, FileText, Layers, Settings, Bell, Calendar, FileCheck } from "lucide-react";
...
const ALL_ROUTES: RouteInfo[] = [
  ...
  { path: "/loans/agreements", name: "Loan Agreements", category: "Loans" },
          ...
          {filteredRoutes.length === 0 ? (
            ...
            <>
              ...
              {filteredRoutes.map((route, idx) => {
                const Icon = getRouteIcon(route.category);
                const categoryColor =
                  route.category === "Debtors" ? "var(--accent-blue)" :
                  route.category === "Loans" ? "var(--primary-color)" :
                  route.category === "Collections" ? "var(--accent-green)" :
                  route.category === "Reports" ? "var(--accent-purple)" : "var(--primary-color)";
                return (
                  <div
                    key={idx}
