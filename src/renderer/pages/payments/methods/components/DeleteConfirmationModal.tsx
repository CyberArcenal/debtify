// src/renderer/pages/payments/methods/components/DeleteConfirmationModal.tsx
...
const DeleteConfirmationModal: React.FC<Props> = ({ isOpen, methodName, onClose, onConfirm, loading }) => (
  <Modal isOpen={isOpen} onClose={onClose} title="Delete Method" size="sm">
    <p style={{ color: "var(--text-primary)" }}>Delete "{methodName}"? This action cannot be undone.</p>
